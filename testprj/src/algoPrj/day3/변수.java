...
public class 변수 {
	...
	public static void main(String[] args) {
		...
		/*
		 * int : 정수형 ,4byte 예시) int a; (+ - 21억)
		 *
		 * byte: 1byte (8bit, 1bit sign -128~+127); short: 2byte (16bit) -32768 ~ 32767
		 * int : 4byte (32bit) -2147483648 ~ 214748347 long : 8byte (64bit) 922경 정도
		 * 
		 * char: 문자형 문자하나를 저장할 수 있는 공간, 2byte 예시) char ch = 'a'; // 한 문자 ' ' 표현; 예시)
		 * char ch2 = '한';
		 * 
		 * double : 실수형데이터를 저장할 수 있는 공간 : 8byte 소수이하 15자리 표현 float : 4byte 소수이해 7자리 표현
		 * 예시) double avg = 11.11;
		 * 
		...
		int iNum = 334; // ok 334라는 값이 상수영역에 저장되는 것
						// iNum 기억장소에 저장되는 것

		// long iLong = 2200000000;
		// 22억 값 상수영역에 서장하는 것에 문제 발생
		//
		long iLong = 220000000L;
		// long형 리터럴값을 표현해야 함 숫자L 로 long형 리터럴표현함

		double d = 23.3; // 23.3 실수형리터럴이 double형으로 상수영역 저장
							// d라는 변수에 저장됨
		// float f = 23.3; // 23.3 상수영역에 저장되는 것이 문제발생 안함
		// double형이 float변수에 저장될 때 문제 발생 됨
		float f = 23.3f; // 상수영역에 float형 값으로 저장될 수 있도록 표현해야함
							// 숫자f 표시해야 float형 상수로 저장됨
		char ch = 'a'; // 한문자를 저장하기 위한 공간을 확보할 때 사용하는 자료형
						// ' ' 한 문자 표현한다.
						// 2byte 사용함
		char ch2 = '김';
		...
		// "i like java" //문자 11개를 저장할 수 이쓴ㄴ 공간 필요 => 문자배열로 표현함
		//
		...
		// 논리 값을 저장할 수 있는 자료형 boolean true,false
		boolean flag = true; // 
