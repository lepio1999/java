...
public class TicketingMain9 {
   ...
   public static void main(String[] args) {
      ...
      loop: while (true) {
          ...
          switch (singer) {
              case 1:
                  menu = singerMenu(sc, ConcertA, ConcertB, ConcertS, ConcertV);
                  break;
              case 2:
                  menu = singerMenu(sc, ConcertB, ConcertB, ConcertS, ConcertV);
                  break;
              case 3:
                  menu = singerMenu(sc, ConcertS, ConcertB, ConcertS, ConcertV);
                  break;
              default:
...
//       String updateSeat = sc.nextLine();
   ...
   public static int singerMenu(Scanner sc, char[] ConcertA, char[] ConcertB, char[] ConcertS, char[] ConcertV) {
	   System.out.println("가수선택 완료");
